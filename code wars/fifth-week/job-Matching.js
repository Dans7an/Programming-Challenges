...
function match(candidate, job) {
  ...
  if(!job.maxSalary || !candidate.minSalary) throw TypeError('Not enough Money!')
    let deduction = candidate.minSalary * 0.1
    return job.maxSalary >= (candidate.minSalary - deduction) ? true : false
